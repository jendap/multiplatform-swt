...
public class MultiPlatformSwtHelperIT {
	...
	public void importSwtJarUninitializedSystemClassLoaderTest() throws ClassNotFoundException {
		final URLClassLoader systemClassLoader =
	...
	@Test(expected = ClassNotFoundException.class)
	public void importSwtJarUninitializedURLClassLoaderTest() throws ClassNotFoundException,
	...
	@Test
	public void importSwtJarInitializedURLClassLoaderTest() throws ClassNotFoundException,
			MalformedURLException {
